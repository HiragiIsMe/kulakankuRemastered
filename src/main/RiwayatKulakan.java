 ...
 * @author hirag
 */
public class RiwayatKulakan extends javax.swing.JPanel {

    private List<Integer> id = new ArrayList<>();
    public RiwayatKulakan() {
        initComponents();
        paintTableHeader();
    ...
    void loadTableMain(String query){
        ...
        tblMain.addColumn("Judul Kulakan");
        ...
        try{
            ...
            while(rs.next()){
                id.add(rs.getInt("id"));
                tblMain.addRow(new Object[]{rs.getString("judul_kulakan"),String.valueOf(rs.getDate("tanggal")), String.valueOf(rs.getInt("total")), rs.getString("catatan")});
            }
    ...
    private void initComponents() {
        ...
        labelHead1.setText("Detail Kulakan");
